...
.user-manager-container { background-color: #ffffff; padding: 1.5rem; border-radius: 0.5rem; box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.075); }
...
.modal-dialog:not(.modal-lg) { max-width: 500px; } /* Confirmation modal */
