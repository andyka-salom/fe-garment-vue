...
<style scoped>
/* Re-use or adapt styles from the User/Role Management component */
.dashboard-view { padding: 2rem 0; background-color: #f8f9fa; }
.product-manager-container { background-color: #ffffff; padding: 1.5rem; border-radius: 0.5rem; box-shadow: 0 0.125rem 0.25rem rgba(0, 0, 0, 0.075); }
...
/* Badge Styles */
.badge.bg-success-light { background-color: rgba(25, 135, 84, 0.1); border: 1px solid rgba(25, 135, 84, 0.2); color: #198754 }
.badge.bg-secondary-light { background-color: rgba(108, 117, 125, 0.1); border: 1px solid rgba(108, 117, 125, 0.2); color: #6c757d; }
...
.modal-dialog:not(.modal-lg):not(.modal-xl) { max-width: 500px; } /* Default size for confirmation, import */

/* Add/Edit Modal Form */
.modern-form .form-label { font-weight: 500; margin-bottom: 0.3rem; font-size: 0.9rem; }
.material-item-row .form-control-sm,
.material-item-row .form-select-sm { font-size: 0.8rem; }

/* Audit Table Styles (reused in Detail Modal) */
.audit-table th { font-size: 0.8rem; padding: 0.5rem; }
.audit-table td { font-size: 0.85rem; padding: 0.5rem; word-break: break-word; }
.audit-changes { max-height: 150px; overflow-y: auto; padding: 5px; background-color: #f8f9fa; border-radius: 4px; border: 1px solid #e9ecef; }
.audit-json { white-space: pre-wrap; word-break: break-all; margin: 0; font-size: 0.8em; max-height: 100px; overflow-y: auto;}
.badge.audit-event-created { background-color: #cff4fc; color: #055160; border: 1px solid #9eeaf9;}
.badge.audit-event-updated { background-color: #fff3cd; color: #664d03; border: 1px solid #ffecb5;}
.badge.audit-event-deleted { background-color: #f8d7da; color: #58151c; border: 1px solid #f1aeb5;}
.badge.audit-event-restored { background-color: #d1e7dd; color: #0f5132; border: 1px solid #a3cfbb;}

/* NEW: Detail Modal Body */
.detail-modal-body {
max-height: 80vh; /* Adjust as needed */
overflow-y: auto;
}
.detail-modal-body .card-title {
  font-size: 1.1rem;
  font-weight: 500;
}
.detail-modal-body dl dt {
  font-weight: 500;
...
.modal-header.bg-warning { border-bottom-color: rgba(0,0,0,0.1); color: #000 !important; }
/* Detail Modal Header */
.modal-header.bg-info { border-bottom-color: rgba(0,0,0,0.15); }
